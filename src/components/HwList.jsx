...
import { Hw18 } from "./hw/hw18/Hw18";
import { Hw19 } from "./hw/hw19/Hw19";
import { Hw20 } from "./hw/hw20/Hw20";
  ...
  return (
    <>
      ...
      <div style={{ position: "relative" }}>
        ...
        <FaqItem question="Homework 20">
          <Hw20 />
        </FaqItem>
        <FaqItem question="Homework 19">
          <Hw19 />
        </FaqItem>
        <FaqItem question="Homework 18">
          <Hw18 />
        </FaqItem>
